...
export const budgetData: Dish[] = [
    {
        ...
        ingredients: [
            { id: "i1-1", name: "Papa Amarilla", quantity: 4, unit: "Kilos", priceUnit: 5.00, priceTotal: 20.00, observations: "La chicas ayudan a prensar las Papas", marketPrices: generateMarketPrices(5.00) },
    ...
    },
    {
        ...
        ingredients: [
            { id: "i2-1", name: "Panceta de cerdo con piel y sin hueso", quantity: 4, unit: "Kilos", priceUnit: 43.80, priceTotal: 175.20, observations: "Viernes 20% descuento", marketPrices: generateMarketPrices(43.80) },
