...
export const INITIAL_PARTICIPANTS: Participant[] = [
    ...
    { id: '12', name: 'Aldo', type: 'Adulto', isActive: false },
    { id: '13', name: 'Pilar', type: 'Adulto', isActive: false },
    { id: '14', name: 'Gaby la Patrona', type: 'Adulto', isActive: false },
    { id: '15', name: 'Momo', type: 'Adulto', isActive: false },
    { id: '16', name: 'Chana', type: 'Adulto', isActive: false },
    { id: '17', name: 'Valentina', type: 'Niño', isActive: false },
    { id: '18', name: 'Francesca', type: 'Niño', isActive: false },
];
