...
export const INITIAL_PARTICIPANTS: Participant[] = [
    { id: '1', name: 'Pepocho', type: 'Adulto', isActive: true, hasPaid: true },
    ...
    { id: '5', name: 'Feny', type: 'Adulto', isActive: true, hasPaid: true },
    { id: '6', name: 'Lucy Pollito', type: 'Adulto', isActive: true, hasPaid: true },
    ...
    { id: '10', name: 'Fernando Calderon', type: 'Adulto', isActive: true, hasPaid: true },
    { id: '11', name: 'Amiga Fernando', type: 'Adulto', isActive: true, hasPaid: true },
    { id: '12', name: 'Aldo', type: 'Adulto', isActive: true, hasPaid: true },
    { id: '13', name: 'Pilar', type: 'Adulto', isActive: true, hasPaid: true },
    { id: '14', name: 'Gaby la Patrona', type: 'Adulto', isActive: true, hasPaid: true },
